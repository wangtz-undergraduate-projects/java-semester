package com.wudaokou.easylearn.retrofit.entityLink;

public class EntityLinkObject {
    String entity_type;
    String entity_url;
    Integer start_index;
    Integer end_index;
    ...
    public EntityLinkObject(String entity_type, String entity_url, Integer start_index, Integer end_index, String entity) {
